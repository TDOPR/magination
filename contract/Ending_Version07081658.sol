...
contract MultiMagicion is Ownable{
    ...
    function findFreeNodeReferrer(address userAddress) private returns(address) {
        ...
        while (true) {
            if (count > 50) {
                Team[userAddress].currentReferrer = address(0x0);
            ...
            if (userIsRegi[userAddress]) {
                if (Team[users[userAddress].referrer].level == 1 && count <= 20) {
                    ...
                    return Team[userAddress].currentReferrer;
                } else if (Team[users[userAddress].referrer].level == 2 && count <= 30) {
                    Team[userAddress].currentReferrer = users[userAddress].referrer;
                    return Team[userAddress].currentReferrer;
                } else if (Team[users[userAddress].referrer].level == 3 && count <= 40) {
                    Team[userAddress].currentReferrer = users[userAddress].referrer;
                    return Team[userAddress].currentReferrer;
                } else if (Team[users[userAddress].referrer].level == 4 && count <= 50) {
                    Team[userAddress].currentReferrer = users[userAddress].referrer;
                    return Team[userAddress].currentReferrer;
                }
            } else {
        ...
        while (true) {
            ...
            if (userIsRegi[userAddress]) {
                if (Team[users[userAddress].referrer].level > level) {
                    if (Team[users[userAddress].referrer].level == 2 && count <= 30) {
                        Team[userAddress].currentReferrer = users[userAddress].referrer;
                        return Team[userAddress].currentReferrer;
                    } else if (Team[users[userAddress].referrer].level == 3 && count <= 40) {
                        Team[userAddress].currentReferrer = users[userAddress].referrer;
                ...
                } else if (Team[users[userAddress].referrer].level == level && level == 4 && count <= 50) {
                    Team[userAddress].currentReferrer = users[userAddress].referrer;
                    return Team[userAddress].currentReferrer;
                } 
            } else {
    ...
    function sendNodeMFSDividends(address userAddress, uint8 level, uint256 _mfsAmount) private  {
        ...
        uint256 superSameLevelBonus = sendMFSAmount.mul(150).div(10000);
        ...
        if (Team[recieveAddress].level == 1) {
                updateTeamAllowanceBalance(recieveAddress, sendMFSAmount.mul(5).div(100));        
                ...
                if (Team[nextRecieveAddress].level == 2) {           
                    ...
                    if (Team[nextRecieveAddress].level == 3) {
                        ...
                        nextRecieveAddress = findNodeReferrer(nextRecieveAddress, Team[nextRecieveAddress].level);
                        if (Team[nextRecieveAddress].level == 4) {
                            updateTeamAllowanceBalance(nextRecieveAddress, sendMFSAmount.mul(40).div(10000));
                        }
                    } else if (Team[nextRecieveAddress].level == 4) {
                        updateTeamAllowanceBalance(nextRecieveAddress, forthRemainLevelBonus);
                        nextRecieveAddress = findNodeReferrer(nextRecieveAddress, Team[nextRecieveAddress].level);
                        if (Team[nextRecieveAddress].level == 4) {
                            updateTeamAllowanceBalance(nextRecieveAddress, sendMFSAmount.mul(70).div(10000));
                        }
                    }
                    }
                    ...
                    if (Team[nextRecieveAddress].level == 4) {
                        ...
                        updateTeamAllowanceBalance(nextRecieveAddress, sendMFSAmount.mul(10).div(100));
                        nextRecieveAddress = findNodeReferrer(nextRecieveAddress, Team[nextRecieveAddress].level);
                        if (Team[nextRecieveAddress].level == 4) {
                            updateTeamAllowanceBalance(nextRecieveAddress, sendMFSAmount.mul(100).div(10000));
                        }
                }
